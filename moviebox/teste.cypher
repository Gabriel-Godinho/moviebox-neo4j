CREATE (EstadosUnidos:Pais {nome: 'Estados Unidos da América', nacionalidade: 'Estadunidense'})
CREATE (Espanha:Pais {nome: 'Espanha', nacionalidade: 'Espanhol(a)'})
CREATE (Brasil:Pais {nome: 'Brasil', nacionalidade: 'Brasileiro(a)'})
CREATE (Ira:Pais {nome: 'Irã', nacionalidade: 'Iraniano(a)'})
CREATE (China:Pais {nome: 'China', nacionalidade: 'Chinês(a)'})
CREATE (CoreiaDoSul:Pais {nome: 'Coreia do Sul', nacionalidade: 'Sul-coreano(a)'})
CREATE (Franca:Pais {nome: 'França', nacionalidade: 'Francês(a)'})
CREATE (Japao:Pais {nome: 'Japão', nacionalidade: 'Japonês(a)'})
CREATE (Russia:Pais {nome: 'Rússia', nacionalidade: 'Russo(a)'})
CREATE (Mexico:Pais {nome: 'México', nacionalidade: 'Mexicano(a)'})
CREATE (ReinoUnido:Pais {nome: 'Reino Unido', nacionalidade: 'Britânico(a)'})
CREATE (Dinamarca:Pais {nome: 'Dinamarca', nacionalidade: 'Dinamarquês(a)'})
CREATE (Suecia:Pais {nome: 'Suécia', nacionalidade: 'Sueco(a)'})
CREATE (Italia:Pais {nome: 'Itália', nacionalidade: 'Italiano(a)'})
